        ...
        <div className="location-wrapper">
          <div className="location-content">
            ...
            <p className="location-description">
              Cư dân Sun Symphony Residences có thể tự hào vì được tận hưởng một
              phong cách sống sang trọng và tiện nghi bậc nhất, với mọi tiện ích
              đều trong tầm tay. Chỉ vài phút di chuyển, bạn có thể thỏa sức mua
              sắm tại các trung tâm thương mại sầm uất, thư giãn tại công viên
              Sun World Asia Park, hay dễ dàng kết nối với thế giới qua sân bay
              quốc tế. Sun Symphony Residences không chỉ đơn thuần là một nơi để
              sống, mà còn là nơi mang đến trải nghiệm sống đỉnh cao, đậm chất
              tinh hoa cho cộng đồng cư dân.
            </p>
              ...
              <div className="nearby-group">
                ...
                <div className="nearby-item">
                  ...
                  <ul className="places">
                    ...
                    <div className="place">
                      Bãi biển Mỹ Khê, Công viên Biển Đông
                    </div>
                  </ul>
                </div>
                <div className="nearby-item">
